...
(function(module, process, console){
	...
	function validSegmentType(segmentname, ID, logger){
		// Custom segments can be added with Z prefix (ZPR, ZAR) that are not part of the HL7 specs
		if (!segmentname[0] || (segmentname[0] !== 'Z' && validSegmentsName.indexOf(segmentname) < 0)){
